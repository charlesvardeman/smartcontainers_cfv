...
class Resource(rdflib.resource.Resource):
    ...
    def __init__(self, id=None, bundle=default_graph):
        super(type(self),self).__init__(default_graph, BNode())
    ...
    def add_type(self,id,rdf_type):
        """
        Add RDF type of resource
        """
        default_graph.add((URIRef(id), RDF.type, rdf_type))
...
class Entity(Resource):
    ...
    def __init__(self, id=None, bundle=default_graph):
        super(Resource, self).__init__(default_graph,URIRef(id))
        print self._graph
        print self._identifier
        print type(self._graph)
        self.add_type(id,PROV.Entity)
